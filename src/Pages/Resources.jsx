  ...
  return (
    <div className="Resources">
      ...
      <div className="article">
        ...
        <div className="art-para">
          <p>
            ...
            commonly abbreviated to ETH, which is its most common signifier. You
            need ETH to pay for some of your interactions with the blockchain,
            and to pay for the items you buy.
          </p>
        </div>
        <div className="art-btn">
          <button>
      ...
      <div className="article">
        ...
        <div className="art-para">
          <p>
            With so many projects out there, we know it can seem hard to find an
            IMG you love. Here are a few things you may want to keep in mind to
